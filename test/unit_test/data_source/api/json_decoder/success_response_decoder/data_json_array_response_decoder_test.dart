  ...
  group('map', () {
    test(
      ...
      () async {
        ...
        // act
        final result = DataJsonArrayResponseDecoder<MockData2>().map(
    ...
    test('should return correct DataListResponse<MockData> when using valid MockData data', () {
      ...
      // act
      final result = DataJsonArrayResponseDecoder<MockData>().map(
        response: validResponse,
    ...
    test('should return correct DataListResponse<String> when using valid String data', () {
      ...
      // act
      final result = DataJsonArrayResponseDecoder<String>().map(
        response: validResponse,
    ...
    test('should return correct DataListResponse<int> when using valid int data', () {
      ...
      // act
      final result = DataJsonArrayResponseDecoder<int>().map(
        response: validResponse,
    ...
    test('should throw AssertionError when response is null', () {
      expect(
        () => DataJsonArrayResponseDecoder<MockData>().map(
          response: null,
          decoder: (json) => MockData.fromJson(json as Map<String, dynamic>),
        ),
    ...
    test('should return null when using incorrect SuccessResponseDecoderType', () async {
      // arrange
