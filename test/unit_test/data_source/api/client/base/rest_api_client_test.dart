...
void main() {
  ...
  group('request', () {
    group('test assertions', () {
      test('should throw AssertionError when method is GET and decoder is null', () async {
        ...
        final restApiClient = RestApiClient(
          dio: _mockDio,
          errorResponseDecoderType: ErrorResponseDecoderType.jsonObject,
      ...
      test(
        'should not throw AssertionError when method is GET and decoder is null but `successResponseDecoderType` is plain',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
    ...
    group('test GET method', () {
      ...
      test(
        'should return null when using `jsonObject` SuccessResponseDecoderType and response is null',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
      ...
      test(
        'should return null when using `plain` SuccessResponseDecoderType and response is null',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
      ...
      test(
        'should return null when using `jsonArray` SuccessResponseDecoderType and response is null',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
          ...
          final restApiClient = RestApiClient(
            dio: _mockDio,
            errorResponseDecoderType: ErrorResponseDecoderType.jsonObject,
            successResponseDecoderType: SuccessResponseDecoderType.jsonArray,
          );
      ...
      test(
        'should return null when using `dataJsonObject` SuccessResponseDecoderType and response is null',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
      ...
      test(
        'should return null when using `dataJsonArray` SuccessResponseDecoderType and response is null',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
    ...
    group('test error cases', () {
        ...
        () async {
          ...
          when(
            ...
            DioException(
              type: DioExceptionType.unknown,
              requestOptions: RequestOptions(),
              error: RemoteException(kind: RemoteExceptionKind.refreshTokenFailed),
            ),
          );
      ...
      test(
        ...
        () async {
          ...
          final restApiClient = RestApiClient(
            dio: _mockDio,
            errorResponseDecoderType: ErrorResponseDecoderType.jsonArray,
            successResponseDecoderType: SuccessResponseDecoderType.jsonObject,
          );
      ...
      test(
        'should throw RemoteException.decodeError when using incorrect errorResponseDecoderType',
        () async {
          // arrange
          const method = RestMethod.get;
          const path = '/v1/auth/login';
